/* the debug functions are in vec.c because they're very long smh */
#ifndef HB_VEC_H
#define HB_VEC_H
...
#ifdef HB_VEC_SHARED
#define HB_VEC_SHARED_LIB 1
#else 
#define HB_VEC_SHARED_LIB 0
#endif



#if defined(HB_VEC_SHARED_LIB) == 0
...
// default fallback
#if defined(HB_VEC_SHARED_LIB==1) 
typedef struct {
  float x,y,z;
} Vec3;
...
// build shared lib... (holy fucking shit i hate rewriting shit twice)
